...
namespace CompileScore.Commands
{
    ...
    /// Command handler
    /// </summary>
    internal sealed class LoadDefaultCommand
    {
        /// <summary>
        /// Command ID.
        /// </summary>
        ...
        private LoadDefaultCommand(AsyncPackage package, OleMenuCommandService commandService)
        {
        ...
        /// </summary>
        public static LoadDefaultCommand Instance
        {
            get;
            private set;
        }
        ...
        public static async Task InitializeAsync(AsyncPackage package)
        {
            ...
            Instance = new LoadDefaultCommand(package, commandService);
        }

...
namespace CompileScore.Commands
{
    ...
    /// Command handler
    /// </summary>
    internal sealed class RebuildCommand
    {
        /// <summary>
        /// Command ID.
        /// </summary>
        ...
        private RebuildCommand(AsyncPackage package, OleMenuCommandService commandService)
        {
        ...
        /// </summary>
        public static RebuildCommand Instance
        {
            get;
            private set;
        }
        ...
        public static async Task InitializeAsync(AsyncPackage package)
        {
            ...
            Instance = new RebuildCommand(package, commandService);
        }

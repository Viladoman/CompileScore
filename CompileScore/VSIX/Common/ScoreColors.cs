namespace CompileScore.Common
{
    ...
    class Colors
    {
        ...
        static Brush InstantiateVariableBrush  = new SolidColorBrush(Color.FromArgb(255, 51,  119, 0));
        static Brush InstantiateConceptBrush   = new SolidColorBrush(Color.FromArgb(255, 51,  119, 51));

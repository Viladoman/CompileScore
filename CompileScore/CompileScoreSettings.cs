...
namespace CompileScore
{
    ...
    public class GeneralSettingsPageGrid : DialogPage
    {
        ...
        private List<uint> optionSeverities = new List<uint> { 1u, 25u, 100u, 500u };
        ...
        [Description("For non normalized severity this defines the maximum value in miliseconds to be considered for this category.")]
